...
export function CitySkyChrome({
  ...
  return (
    <GlassPanel className="pointer-events-none fixed left-4 top-[7.25rem] z-20 max-w-[min(18rem,calc(100vw-2rem))] bg-glass-heavy px-4 py-3 shadow-[0_8px_32px_rgba(5,2,15,0.55),0_0_24px_rgba(124,77,255,0.12)] sm:left-6 sm:top-[7.5rem] sm:px-5 sm:py-3.5">
