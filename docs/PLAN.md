...
1. **Radius = mythic generation.** Every sourced chronological parent edge pushes the child at least one generation farther from the core; cluster baselines stop late variants from dragging ancient figures rimward.
